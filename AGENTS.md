...
every feature across public/local, private mobile, private web, and private
backend ownership. State **not applicable** explicitly when a repository is not
affected.
...
or monetization. Private compositions inject optional capabilities and validate
them before reading any capability-owned provider.
